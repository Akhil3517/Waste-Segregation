...
import { SafeAreaView, StatusBar, StyleSheet, Text, TouchableOpacity, View, Image, Alert, ActivityIndicator, ScrollView, Linking, PermissionsAndroid } from 'react-native';
    ...
    try {
      const granted = await PermissionsAndroid.request(
        PermissionsAndroid.PERMISSIONS.CAMERA,
        {
          ...
          message: 'This app needs access to your camera to take photos for waste detection.',
